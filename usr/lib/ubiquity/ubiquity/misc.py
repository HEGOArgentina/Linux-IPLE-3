...
def install_size():
    ...
    # Maximal size to 7 GB
    max_size = 7 * 1024 * 1024 * 1024
    ...
    # Set minimum size to 7GB if current minimum size is larger
    # than 7GB and we still have an extra 20% of free space
